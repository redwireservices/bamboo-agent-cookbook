...
default['bamboo-agent']['server']['url_prefix'] = 'bamboo'
default['bamboo-agent']['server']['url'] = "#{node['bamboo-agent']['server']['protocol']}://#{node['bamboo-agent']['server']['address']}:#{node['bamboo-agent']['server']['port']}/#{node['bamboo-agent']['server']['url_prefix']}"
